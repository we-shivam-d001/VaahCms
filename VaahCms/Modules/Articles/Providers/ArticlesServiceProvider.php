<?php namespace VaahCms\Modules\Articles\Providers;


use Illuminate\Routing\Router;
use Illuminate\Support\ServiceProvider;
use Illuminate\Database\Eloquent\Factory;
use VaahCms\Modules\Articles\Providers\RouteServiceProvider;
use VaahCms\Modules\Articles\Providers\EventServiceProvider;
...
class ArticlesServiceProvider extends ServiceProvider
{
    ...
    private function registerMiddleware($router) {
        ...
        //register middleware
        //$router->aliasMiddleware('sample.middleware', \Articles\Http\Middleware\SampleMiddleware::class);
    ...
    {
        $viewPath = resource_path('/views/vaahcms/modules/articles');
        ...
        $this->loadViewsFrom(array_merge(array_map(function ($path) {
            return $path . '/views/vaahcms/modules/articles';
    ...
    public function registerAssets()
    {
        ...
        $desPath = public_path('vaahcms/modules/articles/assets');
    ...
    {
        $langPath = resource_path('/lang/vaahcms/modules/articles');
