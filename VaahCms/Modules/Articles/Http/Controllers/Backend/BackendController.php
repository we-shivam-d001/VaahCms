...
class BackendController extends Controller
{
    ...
    public function index(Request $request)
    {
         ...
         */
        /*
        $permission_slug = 'has-access-articles';
    ...
    public function getAssets(Request $request)
    {
        ...
        */
        ...
        $data['module'] = [
            'name' => config('articles.name'),
            'version' => config('settings.global.articles_version')??config('articles.version'),
            'is_dev' => config('articles.is_dev'),
        ];
