...
<html lang="en">
    <head>
        ...
        @if(env('THEME_BLOGTHEME_ENV') == 'develop')
            <link href="http://localhost:8080/blogtheme/assets/css/build.css"
                  rel="stylesheet" media="screen">
            <link href="http://localhost:8080/blogtheme/assets/css/style.css"
                  rel="stylesheet" media="screen">
        @else
            <link  href="{{vh_theme_assets_url("BlogTheme", "css/build.css")}}"
                   rel="stylesheet" media="screen">
            <link  href="{{vh_theme_assets_url("BlogTheme", "css/style.css")}}"
                rel="stylesheet" media="screen">
        @endif
        -->
